...
|:---|:---|
| "Design a [page]..." | `generate_screen_from_text` + Download |
| "Edit this [screen]..." | `edit_screens` + Download |
| "Create/Update .stitch/DESIGN.md" | `get_screen` + Write |
...
- **Design System**: Check for `.stitch/DESIGN.md`. If it exists, incorporate its tokens. If not, suggest creating one.
